...
class KMIClientMFA:
    ...
    # --- 👇 NEW FUNCTION: Store DB Creds 👇 ---
    def store_db_credentials(self, db_data: dict) -> tuple[bool, str]:
        # Securely stores database credentials (username/password).
        if not self.is_connected:
    ...
    def retrieve_db_credentials(self) -> dict | None:
        ...
        try:
            ...
            # Return the whole dict (username + password)
